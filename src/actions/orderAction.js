...
export const newOrder = (order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('https://kiettran.azurewebsites.net/api/v1/order/new', order, config);
...
export const updateOrder = (id, order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`https://kiettran.azurewebsites.net/api/v1/admin/order/${id}`, order, config);
